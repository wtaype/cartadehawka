import{o as I,$ as e,b as L,r as M,M as A,g as H,a as $,q as E,c as O,d as u,w as W,s as v,e as y,i as J,N as d,f as _,h as T,j as b,k as x,l as P,m as q,n as B,p as N,t as R}from"./widev-BeKaoXyd.js";I(y,async f=>{if(!f)return location.href="/";try{const c=H("wiSmile");if(c)return k(c);const j=(await $(E(O(u,"smiles"),W("usuario","==",f.displayName)))).docs[0]?.data();if(!j)return;v("wiSmile",j,450),k(j)}catch(c){console.error(c)}});e(document).on("click",".bt_salir",async()=>{await L(y);try{localStorage.clear()}catch{}location.href="/"});e(document).on("click",".bt_cargar",()=>{M("hojasdbCache","cartasdbCache","wiSmile"),A("Cache limpiado"),setTimeout(()=>location.reload(),700)});function k(f){e(".app").html(`
  <header class="hd">
