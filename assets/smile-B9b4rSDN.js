import{$ as e,r as L,M as j,s as m,g as H,i as M,N as d,b as x,d as P,e as N}from"./widev-Dx3a2SVK.js";import{o as W,m as J,h as $,d as b,a as u,i as C,b as E,q as O,c as T,w as q,f as y,l as R,n as z,p as B}from"./init-PKQicA5Y.js";let D=null;W(y,async h=>{if(!h)return location.href="/";D=h;try{const c=H("wiSmile");if(c)return k(c);const g=(await E(O(T(u,"smiles"),q("usuario","==",h.displayName)))).docs[0]?.data();if(!g)return;m("wiSmile",g,450),k(g)}catch(c){console.error(c)}});e(document).on("click",".bt_salir",async()=>{await J(y);try{localStorage.clear()}catch{}location.href="/"});e(document).on("click",".bt_cargar",()=>{L("hojasdbCache","cartasdbCache","wiSmile"),j("Cache limpiado"),setTimeout(()=>location.reload(),700)});function k(h){e(".app").html(`
  <header class="hd">
    <nav class="nv dfw wdp">
      ...
      <div class="logo nv_right dfw">
        ...
        <button class="bt_login"><i class="fas fa-user"></i> ${h.usuario}</button>
