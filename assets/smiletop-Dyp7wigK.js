import{$ as i,M as n,b as e}from"./widev-Dx3a2SVK.js";/* empty css              */import{o as g,f as b,m as y,b as d,c as u,a as m,r as $,i as w,n as A}from"./init-PKQicA5Y.js";g(b,async l=>{l?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(b),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(l){console.error(l)}});async function S(l){const h=`
