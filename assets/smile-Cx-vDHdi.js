import{$ as e,r as L,M as j,s as m,g as H,i as M,N as d,b as x,d as P,e as N}from"./widev-BM5yT9qV.js";import{o as W,h as J,i as $,d as b,a as u,j as C,b as E,q as O,c as T,w as q,e as y,l as k,k as z,m as B}from"./init-Cp9lDRip.js";let D=null;W(y,async p=>{if(!p)return location.href="/";D=p;try{const c=H("wiSmile");if(c)return R(c);const g=(await E(O(T(u,"smiles"),q("usuario","==",p.displayName)))).docs[0]?.data();if(!g)return;m("wiSmile",g,450),R(g)}catch(c){console.error(c)}});e(document).on("click",".bt_salir",async()=>{await J(y);try{localStorage.clear()}catch{}location.href="/"});e(document).on("click",".bt_cargar",()=>{L("hojasdbCache","cartasdbCache","wiSmile"),j("Cache limpiado"),setTimeout(()=>location.reload(),700)});function R(p){e(".app").html(`
  <header class="hd">
