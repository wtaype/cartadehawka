import{$ as i,M as n,b as e}from"./widev-BM5yT9qV.js";/* empty css              */import{o as g,e as b,h as y,b as d,c as u,a as m,u as $,j as w,k as A}from"./init-Cp9lDRip.js";g(b,async l=>{l?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(b),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(l){console.error(l)}});async function S(l){const h=`
